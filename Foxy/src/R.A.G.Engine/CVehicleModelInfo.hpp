...
namespace rage {
	...
	public:
		...
		struct vector3 m_first_person_driveby_ik_offset; //0x0360
		char pad_036C[4]; //0x036C
		struct vector3 m_first_person_driveby_unarmed_ik_offset; //0x0370
		char pad_037C[20]; //0x037C
		struct vector3 m_first_person_driveby_right_passenger_ik_offset; //0x0390
		char pad_039C[36]; //0x039C
		struct vector3 m_first_person_driveby_right_passenger_unarmed_ik_offset; //0x03C0
		char pad_03CC[4]; //0x03CC
		struct vector3 m_first_person_projectile_driveby_ik_offset; //0x03D0
		char pad_03DC[4]; //0x03DC
		struct vector3 m_first_person_projectile_driveby_passenger_ik_offset; //0x03E0
		char pad_03EC[52]; //0x03EC
		struct vector3 m_first_person_mobile_phone_offset; //0x0420
		char pad_042C[4]; //0x042C
		struct vector3 m_first_person_passenger_mobile_phone_offset; //0x0430
		char pad_043C[20]; //0x043C
		struct vector3 m_pov_camera_offset; //0x0450
