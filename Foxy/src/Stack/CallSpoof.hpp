...
namespace detail {
	...
	struct argumentRemapper {
		...
		static auto doCall(const void* shell, void* shellParam, first fr, second sc, third tr, fourth ft, pack... pc) -> ret {
	...
	struct argumentRemapper<argC, std::enable_if_t<argC <= 4>> {
		...
		static auto doCall(const void* shell, void* shellParam, first fr = {}, second sc = {}, third tr = {}, fourth ft = {}) -> ret {
...
static inline auto spoofCall(const void* trampoline, ret(*fn)(arguments...), arguments... args) -> ret {
	shellParams p{ trampoline, (void*)(fn) };
	using mapper = detail::argumentRemapper<sizeof...(arguments), void>;
	return mapper::template doCall<ret, arguments...>((const void*)&detail::_spooferStub, &p, args...);
}